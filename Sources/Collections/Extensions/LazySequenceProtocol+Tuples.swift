...
extension LazySequenceProtocol {
    ...
    ) -> LazyMapSequence<Self.Elements, (Value0, Value1)> {
        map { element in
            (
    ...
    ) -> LazyMapSequence<Self.Elements, (Value0, Value1, Value2)> {
        map { element in
            (
                element[keyPath: value0KeyPath],
                element[keyPath: value1KeyPath],
    ...
    ) -> LazyMapSequence<Self.Elements, (Value0, Value1, Value2, Value3)> {
        map { element in
            (
                element[keyPath: value0KeyPath],
                element[keyPath: value1KeyPath],
