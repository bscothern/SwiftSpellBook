...
final class LockedTests: XCTestCase, @unchecked Sendable {
    struct S {
        @Locked
        var i: Int
    ...
    func runTest(lockType: Locked<Int>.LockType, file: StaticString = #filePath, line: UInt = #line) throws {
        nonisolated(unsafe) var value = S(.init(wrappedValue: 0, lockType: lockType))
